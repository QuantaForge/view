...
class View implements ArrayAccess, Htmlable, ViewContract
{
     ...
     *
     * @var \QuantaForge\Contracts\View\Engine
     */
    protected $engine;
     ...
     *
     * @param  \QuantaForge\View\Factory  $factory
     * @param  \QuantaForge\Contracts\View\Engine  $engine
     * @param  string  $view
     * @param  string  $path
     * @param  mixed  $data
     * @return void
     ...
     *
     * @param  \QuantaForge\Contracts\Support\MessageProvider|array  $provider
     * @param  string  $bag
     * @return $this
     */
     ...
     *
     * @return \QuantaForge\View\Factory
     */
     ...
     *
     * @return \QuantaForge\Contracts\View\Engine
     */
