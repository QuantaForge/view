...
trait CompilesComponents
{
    ...
    public static function compileClassComponentOpening(string $component, string $alias, string $data, string $hash)
    {
        return implode("\n", [
            ...
            '<?php $component = '.$component.'::resolve('.($data ?: '[]').' + (isset($attributes) && $attributes instanceof QuantaForge\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>',
    ...
    {
        return "<?php \$attributes ??= new \\QuantaForge\\View\\ComponentAttributeBag; ?>
